    ...
    const fetchData = async () => {
      try {
        ...
        if (userProductsRes.data.length === 0) {
          showAlert(
            "You need to create a product first before creating an auction",
            "info"
          );
        ...
        <div className="col-lg-8">
              ...
              <form onSubmit={onSubmit}>
                ...
                {isScheduled ? (
                  ...
                  <div className="mb-4">
                    <div className="alert alert-info d-flex align-items-center">
                      ...
                      <div>
                        <strong>Immediate Auction:</strong> Your auction will
                        start as soon as you submit this form and will end after
                        the duration you select below.
                      </div>
                    </div>
                ...
                <div className="row mb-4">
                  <div className="col-md-6 mb-3 mb-md-0">
                    ...
                    <div className="form-text">Initial bid amount</div>
                  </div>
                  <div className="col-md-6">
                    <label
          ...
          <div className="card shadow border-0 rounded-3">
            ...
            <div className="card-body p-4">
              <ul className="mb-0">
                <li className="mb-2">
                  Be accurate in your product description and condition
                </li>
                <li className="mb-2">
                  Set a fair starting price to attract initial bids
                </li>
                <li className="mb-2">
                  Respond promptly to questions from potential bidders
                </li>
                <li className="mb-2">
                  Choose an appropriate auction duration based on item value and
                  demand
                </li>
                <li className="mb-2">
                  Be prepared to ship or deliver the item after the auction ends
                </li>
              </ul>
            </div>
          </div>
              ...
              {product ? (
                <>
                  ...
                  <div className="mb-3">
                    ...
                    <p className="fw-bold mb-0">
                      {Math.ceil(
                        (endTime - (isScheduled ? startTime : new Date())) /
                          (1000 * 60 * 60 * 24)
                      )}{" "}
                      day(s)
                    </p>
                  ...
                  <div className="mb-3">
                    ...
                    <p className="fw-bold mb-0">
                      ${parseFloat(startingBid || 0).toFixed(2)}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="fw-bold mb-0">
                      ${parseFloat(minBidIncrement).toFixed(2)}
                    </p>
                  </div>
                </>
              ) : (
                <p className="text-center text-muted">
                  Please select a product to see auction summary
                </p>
              )}
            </div>
          </div>
