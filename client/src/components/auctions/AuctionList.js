  ...
  useEffect(() => {
    if (socket && socket.socket) {
      ...
      socket.socket.on("auctionStatusChanged", (updatedAuction) => {
        console.log(
          "Auction status change received via socket:",
          updatedAuction
        );
        setAuctions((prevAuctions) => {
              ...
              <div className="card h-100 shadow-sm auction-card fade-in">
                <div className="position-relative">
                  <img
                    ...
                    alt={
                      auction.product ? auction.product.name : "Auction Item"
                    }
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    {auction.product ? auction.product.name : "Unknown Item"}
                  </h5>
                    ...
                    <div>
                      ...
                      <small className="text-muted">
                        {auction.currentHighestBidder
                          ? `Highest Bidder: ${
                              auction.currentHighestBidder.username || "Unknown"
                            }`
                          : "No bids yet"}
                      </small>
                    </div>
