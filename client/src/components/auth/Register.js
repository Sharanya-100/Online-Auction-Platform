              ...
              <div className="d-flex">
                ...
                <div>
                  ...
                  <p className="mb-0 text-muted">
                    We're committed to protecting your personal data. Read our <button type="button" className="btn btn-link text-decoration-none p-0">Privacy Policy</button> to learn more.
                  </p>
                </div>
              </div>
            </div>
