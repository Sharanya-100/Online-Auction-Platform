...
const CreateProduct = ({ showAlert }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const confirmAuction = window.confirm(
        "Would you like to create an auction for this product now?"
      );
      ...
      <div className="row mb-4">
        <div className="col-md-8">
          ...
          <p className="lead text-muted">
            Create a new product to sell through auction.
          </p>
        </div>
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <div className="form-text">
                    Include details like brand, model, dimensions, features, and
                    condition notes.
                  </div>
                </div>
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item px-0 d-flex align-items-center border-0">
                  ...
                  <div>
                    ...
                    <p className="mb-0 text-muted small">
                      Be thorough and honest about condition
                    </p>
                  </div>
                </li>
                <li className="list-group-item px-0 d-flex align-items-center border-0">
                  ...
                  <div>
                    ...
                    <p className="mb-0 text-muted small">
                      Research similar items to set a fair starting price
                    </p>
                  </div>
                </li>
                <li className="list-group-item px-0 d-flex align-items-center border-0">
                ...
                <li className="list-group-item px-0 d-flex align-items-center border-0">
                  ...
                  <div>
                    ...
                    <p className="mb-0 text-muted small">
                      Be ready to answer questions about your item
                    </p>
                  </div>
                </li>
              </ul>
                ...
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0 small">
                      After creating your product, you can immediately set up an
                      auction or do it later from your dashboard.
                    </p>
                  </div>
                </div>
              </div>
